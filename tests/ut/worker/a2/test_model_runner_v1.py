...
class TestNPUModelRunnerKVCache(unittest.TestCase):
    ...
    def test_sparse_layer_without_indexer_uses_smaller_kv_cache_spec(
        ...
        # The runtime implementation is the source of truth. Keep the wrapper
        # attributes intentionally inconsistent to cover wrapped Indexers.
        attn_module.indexer = object()
        ...
        indexer_attn_module.indexer = None
        indexer_attn_module.impl = SimpleNamespace(has_indexer=True)
        ...
        self.assertFalse(
            is_kv_cache_spec_uniform(
                {
                    "model.layers.0.self_attn.attn": indexer_spec,
